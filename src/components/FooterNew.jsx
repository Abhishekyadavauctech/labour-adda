        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-10 flex justify-between">
          ...
          <div>
            ...
            <ul className=" space-y-3 text-gray-300">
              ...
              <a href="tel:2896446735"><li className="flex items-center gap-2"> <Phone className="w-5 h-5 text-white-700" />2896446735</li></a>
              <a href="mailto:info@partyhubconnect.com"> <li className="flex items-center gap-2"><Mail className="w-5 h-5 text-white-700" /> info@partyhubconnect.com</li></a>
            </ul>
